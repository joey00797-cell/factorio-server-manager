        ...
        <Panel
            ...
            content={
                <>
                    ...
                    <p className="mb-4"><Trans i18nKey="help.bugs_help_content" components={[<a className="text-blue hover:text-blue-light" target="_blank" href="https://github.com/OpenFactorioServerManager/factorio-server-manager/issues">x</a>]}/></p>
